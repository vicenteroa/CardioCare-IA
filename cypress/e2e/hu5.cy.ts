...
describe('HU5: Seguridad y Evitar mal uso de la plataforma', () => {
  ...
  it('Verifica detección limite minimo caracter en el testimonio', () => {
    ...
    cy.get('[data-astro-source-loc="58:14"] > input').click()
    cy.get('[data-astro-source-loc="65:14"] > input').click()
    cy.get('[data-astro-source-loc="75:14"] > input').click()
